...
class TypeAliasRule(BaseRule):
    ...
    def check(
        ...
        for info in collect_imports(node).imports:
            if info.module == "typing" and info.name == "TypeAlias" and not (info.version_guarded and info.version_guarded >= (3, 10)):
                findings.append(Finding(
                    ...
                    suggestion="Guard with: if sys.version_info >= (3, 10): from typing import TypeAlias -- or use typing_extensions.",

...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
typing.TypeGuard was added in Python 3.10 (PEP 647).
                ...
                for alias in n.names:
                    if alias.name == "TypeGuard":
                        findings.append(Finding(
                            ...
                            title=self.title,
                            description=(
                                "typing.TypeGuard was added in Python 3.10 "
                                "(PEP 647). Importing it on Python 3.9 or "
                            ...
                            suggestion=(
                                ...
                                "else: from typing_extensions import TypeGuard"
                            ),
                            docs_url="https://peps.python.org/pep-0647/",
                        ))
        return findings
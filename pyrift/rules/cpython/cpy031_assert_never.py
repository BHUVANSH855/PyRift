...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
typing.assert_never was added in Python 3.11 (PEP 673).
                ...
                for alias in n.names:
                    if alias.name == "assert_never":
                        findings.append(Finding(
                            ...
                            title=self.title,
                            description=(
                                "typing.assert_never was added in Python 3.11 "
                                "(PEP 673). Importing it on Python 3.10 or "
                            ...
                            suggestion=(
                                ...
                                "else: from typing_extensions import assert_never"
                            ),

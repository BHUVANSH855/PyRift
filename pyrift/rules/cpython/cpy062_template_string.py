        ...
        for info in imp_map.imports:
            if info.module == "string.templatelib" or (info.module and info.module.startswith("string.templatelib")):
                findings.append(Finding(
                    ...
                    description="string.templatelib (t-strings) was added in Python 3.14 (PEP 750). Importing it on 3.13 or below raises ModuleNotFoundError.",
                    severity=Severity.ERROR, runtime=Runtime.CPYTHON,
                    affected_from="3.0", affected_until="3.13",
                    suggestion="Guard with: if sys.version_info >= (3, 14): from string.templatelib import Template",

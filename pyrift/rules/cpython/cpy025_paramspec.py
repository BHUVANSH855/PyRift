...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
typing.ParamSpec was added in Python 3.10 (PEP 612).
                ...
                for alias in n.names:
                    if alias.name == "ParamSpec":
                        findings.append(Finding(
                            ...
                            title=self.title,
                            description=(
                                "typing.ParamSpec was added in Python 3.10 "
                                "(PEP 612). Importing it on Python 3.9 or "
                            ...
                            docs_url="https://peps.python.org/pep-0612/",
                        ))
        return findings
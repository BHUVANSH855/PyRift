...
class WeakrefProxyRule(BaseRule):
    ...
    def check(
        ...
        weakref_alias = imp_map.alias_for("weakref") or "weakref"

        proxy_aliases = {
            imp.alias or imp.name
            for imp in imp_map.imports
            if imp.module == "weakref" and imp.name == "proxy"
        }
        ...
        for n in ast.walk(node):
            ...
            if (
                ...
                and func.value.id == weakref_alias
            ) or (
